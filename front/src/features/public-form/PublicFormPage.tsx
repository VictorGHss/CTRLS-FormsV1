...
export default function PublicFormPage() {
  ...
  const submitMutation = useMutation({
    ...
    onError: (error: any) => {
      alert(error.response?.data?.message || 'Erro ao enviar formulário. Tente novamente.');
    },
  });
        ...
        <Card>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setPatientInfo({ ...patientInfo, nascimento: e.target.value })}
                      required
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      onChange={(e) => setPatientInfo({ ...patientInfo, sexo: e.target.value as 'M' | 'F' })}
                      required
                    >
              ...
              {formFields.length > 0 && (
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold border-b pb-2">Questionário</h3>
